...
namespace CourseWork_RPVS.Classes.Data {
    class SaveConfig {
        ...
        public void SaveDataInINIFile() {
            try {
                iniFile = new INIFileManager(@"D:\Learning\BNTU\Subjects\CourseWork\CourseWork_RPVS\CourseWork_RPVS\DataFile\INIFile.ini");
        ...
        public static void SaveSession() {
            ...
            try {
                iniFile = new INIFileManager(Path.GetFullPath("../../DataFile/sessionINI.ini"));
                iniFile.WriteINI("main", "Date", SaveData.Date);
                iniFile.WriteINI("main", "Path", SaveData.FilePath);
            }
        ...
        public static void LoadSession() {
            ...
            try {
                iniFile = new INIFileManager(Path.GetFullPath("../../DataFile/sessionINI.ini"));
                SaveData.Date = iniFile.ReadINI("main", "Date");
                SaveData.OldFilePath = iniFile.ReadINI("main", "Path");
            }
            catch (Exception e) { Console.WriteLine(e); }
        }
    }
